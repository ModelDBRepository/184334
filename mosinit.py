'''
Current clamp demo using Allen Brain's model 473863510.
...
from neuron473863510 import Neuron473863510
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473863510(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473863510; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-85.0781555176)
        h.fcurrent()
